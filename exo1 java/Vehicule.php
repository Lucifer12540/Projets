...
abstract class Vehicule 
{
    ...
    abstract function freinamain($vitesse);
...
class Voiture extends Vehicule 
{
    ...
    public function freinamain($vitesse) 
	{
		if ( $this->estDemarre() ) 
		{
			$this->setFreinamain($this->getFreinamain());
		}

		else 
		{
			trigger_error('On ne peut pas mettre le frein à main le moteur est en marche', E_USER_WARNING);
		}
	}
